...
(function (root) {
	...
	function MyDate(day, month, year) {
		...
		this.toString = function () {
			...
			return this.timezone === 'en-US' ? this.month + '/' + this.day + '/' + this.year : this.day + '/' + this.month + '/' + this.year;
		};

		this.dateTypeString = function () {
			return '' + mkMilitar(_this.year, _this.month, _this.day);
		};
